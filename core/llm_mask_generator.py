...
class LLMMaskGenerator:
    ...
    def _default_prompt_template(self) -> str:
        return (
            ...
            "3. УНИКАЛЬНЫЕ ИМЕНА ГРУПП: каждое имя (?P<name>) должно быть УНИКАЛЬНЫМ. "
            "НЕ дублируй одно и то же имя группы дважды в одном паттерне. "
            "Если покрытие и технические_характеристики оба нужны — используй только одно из них.\n"
            "4. Используй named groups (?P<name>...) для захвата значений.\n\n"
            "### ВХОДНЫЕ ДАННЫЕ\n"
