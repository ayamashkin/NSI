...
# 2026-06-08 11:00:00 — FIX 14v3: суффикс после ОСТ/ГОСТ — (?:\s+.*)?$.
#   Ловит "по 226.57...", "080340004", любой текст после стандарта. Идемпотентный.
# 2026-06-10 08:00:00 — FIX 1b/13/14: Приоритет 1. +~1914 записей.
#   1b: [mм]→[mмMМ] (+1704), 13: Закл[её]пка (+156), 14: суффикс (+54).
# 2026-06-0 03:00:00 — FIX 11/12: ГОСТ 5915/3128/3129 полная замена маски. 15/15.
# 2026-06-06 01:00:00 — FIX 10: ГОСТ 1491/17475 [mмMМ]. SOFT_PARAMS={'длина'}. +~2600.
# 2026-06-05 21:30:00 — FIX: Винт M опциональный [mм]?, coating цифры 58.029, класс[ABАВ], х/\-.
#   Штифт: покрытие опциональное + буква, диаметр [.,]. bugs1(2): 27.6% (1265/4580).
# 2026-06-05 18:10:00 — FIX: r-strings во всех литералах _apply_mask_fixes. SyntaxWarning устранены.
...
class AutomatedParametricProcessor:
    ...
    def _apply_mask_fixes(pattern: str) -> str:
        ...
        # Винт Ам5-8нх8.58 = класс(A)+м(мелкий)+диам(5)-длина(8)+кдоп(н)+х+покр(8.58)
        # [mмMМ] — заглавная М кирилл (U+041C) для "Винт М1,2-10"
