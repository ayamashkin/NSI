...
python cli.py generate-masks -d cache/masks.db -i models/ens_hardware_test.pkl --force --llm --domain hardware --validate --standard "ОСТ 1 31104-80" -so output/mask_stats.xlsx
...
python cli.py generate-masks -d cache/masks.db -i models/ens_hardware_test.pkl --llm --domain hardware --validate -so output/mask_stats.xlsx
...
python cli.py batch data/nomenclature2.xlsx -d cache/masks.db -i models/ens_hardware.pkl --workers 1 -o output/nomenclature2.json --domain hardware --no-cache
python cli.py batch data/nomenclature2.xlsx -d cache/masks.db -i models/ens_hardware.pkl --workers 1 -o output/nomenclature2.xlsx --domain hardware --no-cache
...
python cli.py batch data/bugs2.xlsx -d cache/masks.db --domain hardware --workers 2 -o output/bugs2.xlsx
python cli.py batch data/bugs4.xlsx -d cache/masks.db --domain hardware --workers 2 -o output/bugs4.json
